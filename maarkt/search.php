<!-- SEARCH PAGE, this page handles the "Search Post" functionality which will retrieve posts that contain the users search term(s) -->
        ...
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
              ...
              <a class="dropdown-item" href="departments/ohter.php">Other</a>
            </div>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				...
				<p class="lead text-muted">Here you will find all of the items related to your search.</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					$query = $_POST['query'];
					$sql = "SELECT * FROM posts WHERE (`itemName` LIKE '%".$query."%') OR (`description` LIKE '%".$query."%')";
