...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Sports & Outdoor Recreation</h1>
				<p class="lead text-muted">Here you will find listings related to sports and outdoor recreation items such as basketballs, exercise equipment, bikes, camping gear, and many more!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					<?php
					// Create connection
					$mysqli = new mysqli("localhost", "id15988271_s85gill", "November_567558", "id15988271_sgill");
					// Check connection
					if ($mysqli->connect_error) {
						die("Connection failed: " . $mysqli->connect_error);
					}

					// Get all the posts from the Sports & Outdoors category
					$sql = "SELECT * FROM posts WHERE category = 'Sports & Outdoors' ORDER BY id DESC";
