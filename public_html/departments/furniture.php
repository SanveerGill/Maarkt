...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Furniture</h1>
				<p class="lead text-muted">Here you will find all types of furniture such as couches, coffee tables, beds, desks, and many more!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from the Furniture category
					$sql = "SELECT * FROM posts WHERE category = 'Furniture' ORDER BY id DESC";
