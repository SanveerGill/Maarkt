...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Electronics</h1>
				<p class="lead text-muted">Here you will find all types of electronics such as laptops, computers, headphones, TVs, and many more!.</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from the Electronics category
					$sql = "SELECT * FROM posts WHERE category = 'Electronics' ORDER BY id DESC";
