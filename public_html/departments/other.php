...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Other</h1>
				<p class="lead text-muted">Here you will find all listings that may not fit any of the other categories we have!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from the Other category
					$sql = "SELECT * FROM posts WHERE category = 'Other' ORDER BY id DESC";
