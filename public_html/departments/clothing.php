...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Clothing</h1>
				<p class="lead text-muted">Here you will find all types of clothing such as sweaters, jackets, pants, shoes, and many more!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all posts from the Clothing category
					$sql = "SELECT * FROM posts WHERE category = 'Clothing' ORDER BY id DESC";
