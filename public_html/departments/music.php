...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Music</h1>
				<p class="lead text-muted">Here you will find all types of items relating to music such as CDs, vinyls, musical instruments, and many more!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from the Music category
					$sql = "SELECT * FROM posts WHERE category = 'Music' ORDER BY id DESC";
