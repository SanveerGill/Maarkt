...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Video Games</h1>
				<p class="lead text-muted">Here you will find all types of games across all platforms and consoles such as Playstation, XBOX, PC, and many more!</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from the Video Games category
					$sql = "SELECT * FROM posts WHERE category = 'Video Games' ORDER BY id DESC";
