...
<body>
	...
	<main role="main">
		...
		<section class="jumbotron text-center">
			<div class="container">
				<h1>Automotive</h1>
				<p class="lead text-muted">Here you will find all listings related to cars, vehicle parts, motorcycles, boats, and many more! .</p>
			</div>
		</section>
		...
		<div class="album py-5 bg-light">
			<div class="container">
				...
				<div class="row">
					...
					// Get all the posts from Automotive category
					$sql = "SELECT * FROM posts WHERE category = 'Automotive' ORDER BY id DESC";
